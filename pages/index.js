      ...
      <Main>
        <div className={styles.section}>
          <div className={styles.sectionInner}>
            ...
            <br />
            <Heading3>
              Arena-level drummer renowned for deep groove, musical intuition,
              and global touring experience.
            </Heading3>
        ...
        <div className={styles.section}>
          <div className={styles.sectionInner}>
            ...
            <Text>
              ...
              records.spent six months working intensely with Jimmy Jam & Terry
              Lewis, spending 5-6 days a week in the studio, working one-on-one,
              jamming together into the early hours of the morning, writing
              songs and eating every meal together.
            </Text>
            <br />
            <br />
            <div className={styles.imgContainer}>
        ...
        <div className={styles.section}>
          <div className={styles.sectionInner}>
            ...
            <Text>
              ...
              label deal with Epic Records. Scouted by LA Reid, Jakubi tours the
              U.S. four times selling out 300-500 cap rooms from New York City
              to Los Angeles.In between tours, writing and working with Macy
              Gray and Scott Storch (The Roots / Dr. Dre / 50 Cent / Beyonce /
              Nas) and supported legendary artists such as Sublime, Fishbone,
              The Suffers.
            </Text>
            <br />
            <br />
